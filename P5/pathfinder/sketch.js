...
function draw() {
  ...
  if (found) {
    ...
    document.getElementById("path_nodes").innerHTML =
      "path length:" + found_path_length;
    noLoop();
  }
  document.getElementById("wall_ratio").innerHTML = "wall ratio:" + wall_ratio;
  document.getElementById("total_nodes").innerHTML =
    "total nodes discovered:" + total_nodes_visited;
}
